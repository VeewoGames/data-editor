...
const profile = stableClusterProfiles.list;
export const promoteStablePrefixBatch14Suggestion = (suggestion) => promoteStableClusterSuggestion(suggestion, profile);
export const promoteStreamlineStablePrefixBatch14Suggestions = (payload) => promoteStableClusterSuggestions(payload, profile);
