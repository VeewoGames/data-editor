...
function DataTableComponent(props: DataTableProps) {
  ...
  const tableColumnsRuntime = useMemo(() => ({
    ...
    textEditable: snapshot.textEditable,
    activeTextCellId,
    truncationHintSuppressed: selectionPointerActive || rowDragVisual != null || columnDragSession != null || activeOptionFieldCellId != null || openRowActionId != null,
