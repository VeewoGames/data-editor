...
const registryEntries = [
  {
    sourcePathSuffix: "data/content/classes.json",
    collectionPath: "$",
  ...
  {
    sourcePathSuffix: "data/content/affixes.json",
  ...
  {
    sourcePathSuffix: "data/content/affixes_mechanic.json",
    collectionPath: "$",
  ...
  {
    sourcePathSuffix: "data/content/runes.json",
    collectionPath: "$",
    rootField: "effects",
    nestedPath: ["[]"],
  ...
  {
    sourcePathSuffix: "data/content/traits.json",
