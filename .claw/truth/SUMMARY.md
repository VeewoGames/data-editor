...
- [entry-action legacy 协议已硬禁用，pre-enable 文件安全与恢复基础已落地](./entry-actions-legacy-protocol-hard-disable-and-preenable-fencing-recovery.md)
...
- [entry-action legacy direct-write 协议的硬禁用与安全前置边界](./adr/entry-actions-legacy-direct-write-hard-disable.md)
