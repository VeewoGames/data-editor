...
- [Nocturnel 技能预算模型：单点权威入口、repo-local `data-design-skill-player` 设计入口与 persisted dev_doc 模板边界](./nocturnel-skill-budget-model-analysis.md)
- [Nocturnel 技能预算账本模型：独立预算账本层、单点预算指南、技能开发文档模板结构、设计入口职责边界、`skill_axe_throw` 首个正式样例与同池校准锚点](./adr/nocturnel-skill-budget-ledger-model.md)
- [Nocturnel 玩家技能正式评审与实现完成门禁：设计/评审/验证职责、repo-local Skill 选择现有字段、canonical 文档写回、双轴结果及失败关闭边界](./nocturnel-player-skill-review-and-completion-gates.md)
- [Nocturnel 玩家技能评审权威与验证门禁：正式评分单一 ownership、设计 proposal 的 Skill 字段合同、canonical 只读评审与项目专用能力归属](./adr/nocturnel-player-skill-review-authority-and-verification-gate.md)
...
- [历史：detail panel 条目级 Codex 自动化的 legacy 维护与执行链](./detail-panel-entry-codex-automation-boundary.md)
- [entryActions 第二版方向收敛：放弃项目共享，转为双层个人化配置](./entry-actions-v2-personal-automation-direction.md)
- [entryActions 第二版第一阶段：共享规则与本地绑定的存储/API、ETag 与无通用字段白名单的 target schema](./entry-actions-v2-phase1-storage-and-api-foundation.md)
- [entryActions 第二版第二阶段：正式运行时真值切换、个人自动化入口、Rule Id/binding 草稿事务与最小校验面板](./entry-actions-v2-phase2-automation-settings-entry-and-import.md)
- [历史：entryActions 第二版 profile / binding 接入 legacy 执行链的运行时快照](./entry-actions-v2-runtime-truth-switch-and-final-state.md)
